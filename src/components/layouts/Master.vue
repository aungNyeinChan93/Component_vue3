                ...
                <div class="md:flex md:items-center md:gap-12">
                    <nav aria-label="Global" class="hidden md:block">
                        <ul class="flex items-center gap-6 text-sm">
                            <li>
                                <RouterLink :class="{ '!bg-green-400': $route.name == 'home' }"
                                    class="text-gray-500 transition px-2 py-1 rounded " :to="{ name: 'home' }">
                                    Home
                                </RouterLink>
                            </li>

                            <li>
                                <RouterLink :class="{ '!bg-green-400': $route.name == 'about' }"
                                    class="text-gray-500 transition px-2 py-1 rounded " :to="{ name: 'about' }">
                                    About
                                </RouterLink>
                            </li>

                            <li>
                                <RouterLink :class="{ '!bg-green-400': $route.name == 'coffee' }"
                                    class="text-gray-500 transition px-2 py-1 rounded " :to="{ name: 'coffee' }">
                                    Coffee
                                </RouterLink>
                            </li>
                            ...
                            <li>
                                <RouterLink :to="{ name: 'products' }"
                                    :class="{ 'text-gray-500 transition px-2 py-1 rounded ': true, '!bg-green-400': $route.name === 'products' }">
                                    Products
                                </RouterLink>
                            </li>
                            ...
                            <li>
                                <RouterLink :to="{ name: 'contact' }"
                                    :class="{ 'text-gray-500 transition px-2 py-1 rounded ': true, '!bg-green-400': $route.name === 'contact' }">
                                    Contact
                                </RouterLink>
                            </li>
